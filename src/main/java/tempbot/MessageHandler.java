...
public class MessageHandler extends ListenerAdapter {
	...
	public MessageHandler(Processor processor, String selfUserId) {
		...
		rawBotMentionPattern = Pattern.compile("<@!?" + selfUserId + ">");
	...
	handle(Message message, boolean isPrivateMessage) {
		...
		var botWasMentioned =
			message.getMentions().getUsers().stream()
			.anyMatch(user -> user.getId().equals(selfUserId));
